...
- (void)viewDidLoad
{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://google.co.jp"]];
    ...
    self.navigationItem.rightBarButtonItems = @[_backButton, _forwardButton, _reloadButton];
}
